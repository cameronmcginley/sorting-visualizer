const getMergeSortanimationFrames = (bars_state, highlightEnabled) => {
    ...
    mergeSort(bars, auxBars, animationFrames, 0, bars.length-1, highlightEnabled)
...
const mergeSort = (bars, auxBars, animationFrames, firstIndex, lastIndex, highlightEnabled) => {
    ...
    mergeSort(auxBars, bars, animationFrames, firstIndex, midIndex, highlightEnabled);
    mergeSort(auxBars, bars, animationFrames, midIndex+1, lastIndex, highlightEnabled);
